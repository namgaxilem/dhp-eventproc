...
@Converter
@Slf4j
public class CryptoConverterGCMPasswordBase implements AttributeConverter<String, String> {
    ...
    public String convertToDatabaseColumn(String attribute) {
        try {
            System.out.println("keyvaultSecret: " + keyvaultSecret);
            String encrypted = encrypt(attribute.getBytes(UTF_8), keyvaultSecret);
            return encrypted;
        } catch (Exception e) {
    ...
    public String convertToEntityAttribute(String dbData) {
        try {
            System.out.println("keyvaultSecret: " + keyvaultSecret);
            return decrypt(dbData, keyvaultSecret);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
